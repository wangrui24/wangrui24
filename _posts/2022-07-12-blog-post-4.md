...
因此$E[Y(1)-Y(0)]=E\big[\frac{I(A=1)Y}{P(A=1|X)}\big]-E\big[\frac{I(A=0)Y}{P(A=0|X)}\big]$。 其中，$P(A=1|X)$经常被称作倾向得分(propensity score)，记作e(X)。这种方法也可以被叫做倾向得分加权。
...
$$E[Y(1,A(1))-Y(0, A(0))] = E[Y(1,A(1))-Y(0, A(0))|A(0)=0,A(1)=1]P(A(0)=0,A(1)=1)$$
