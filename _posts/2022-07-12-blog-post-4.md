...
其次，由于不存在Defier，因此$P(A(0)=1,A(1)=0)=0$,又由排他性我们知道$E[Y(1,A(1))-Y(0, A(0))\mid A(0)=0,A(1)=0]=E[Y(0)-Y(0)\mid A(0)=0,A(1)=0]=0$, $E[Y(1,A(1))-Y(0, A(0))\mid A(0)=1,A(1)=1]=E[Y(1)-Y(1)|A(0)=1,A(1)=1]=0$.所以
